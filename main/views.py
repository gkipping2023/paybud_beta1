...
def logbook_calc(request):
    ...
    c_base = 3500.00
    c_g_rep = 2913.00 #CC 2026
    c_prima = 650.00
    c_viatico = 2398.00 #CC 2026
    c_viatico_extra = 18.00
    c_prima_extra = 85.31
    c_rata = round((c_base + c_g_rep)/ 72,2) #CC 2026
    ...
    fo_atp_base = 1915.00
    fo_atp_grep = 1494.00 #CC 2026
    fo_atp_prima = 264.00
    fo_atp_viatico = 1535.00 #CC 2026
    fod_natp_grep = 1364.00 #CC 2023 TablaC
    fo_natp_grep = 200.00 #CC 2026 TablaD
    fo_atp_viatico_extra = 13.00
    fo_atp_prima_extra= 32.20
    fo_atp_rata = round((fo_atp_base + fo_atp_grep)/72,2)
    fod_natp_rata = round((fo_atp_base + fod_natp_grep)/72,2)
    fo_natp_rata = round((fo_atp_base + fo_natp_grep)/72,2)
    css_pa = 0.0975
    s_educ = 0.0125
    unpac = 0.01
    isr_grep = 0.1
